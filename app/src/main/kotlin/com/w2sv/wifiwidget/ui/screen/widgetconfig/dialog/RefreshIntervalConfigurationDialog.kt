...
fun RefreshIntervalConfigurationDialog(
    ...
    ConfigurationDialog(
        ...
        LaunchedEffect(hourPickerState.snappedIndex, minutePickerState.snappedIndex) {
            ...
            isInvalidSelection = hourPickerState.snappedIndex == 0 && minutePickerState.snappedIndex < 15
            if (!isInvalidSelection) {
                configuredInterval = hourPickerState.snappedIndex.hours + minutePickerState.snappedIndex.minutes
            }
        }
