...
object HorizontalSlideTransitions : PopNonPopIdenticalAnimatedDestinationStyle() {
    override val enterTransition: NavigationEnterTransition = { slideInHorizontally() + fadeIn() }
    override val exitTransition: NavigationExitTransition = { slideOutHorizontally() + fadeOut() }
}